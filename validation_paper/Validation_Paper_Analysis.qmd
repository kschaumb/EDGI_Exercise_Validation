...
+======================+======================+======================+
| Exercise for Weight  | To control weight    | NA                   |
| Control              | and shape --         |                      |
...
|                      | more                 |                      |
+----------------------+----------------------+----------------------+
| Regular Exercise for | To control weight    | NA                   |
...
|                      | often'               |                      |
+----------------------+----------------------+----------------------+
| Compulsive Exercise  | Exercise for Weight  | Exercise for Weight  |
|                      | Control +            | Control              |
|                      |                      |                      |
|                      | Ever felt compelled  |                      |
|                      | to exercise == 'YES' |                      |
...
|                      | == 'YES'             |                      |
+----------------------+----------------------+----------------------+
| Regular Compulsive   | Regular Exercise for | Exercise for Weight  |
| Exercise             | Weight Control       | Control              |
|                      |                      |                      |
|                      | Ever felt compelled  | Regular Exercise for |
|                      | to exercise == 'YES' | Weight Control       |
|                      | OR Ever uneasy or    |                      |
|                      | distressed when      | Compulsive Exercise  |
|                      | unable to exercise   |                      |
|                      | == 'YES'             |                      |
+----------------------+----------------------+----------------------+
| Current Compulsive   | Compulsive Exercise  | Compulsive Exercise  |
| Exercise             |                      |                      |
|                      | Do you currently     |                      |
|                      | exercise to control  |                      |
|                      | weight and shape AND |                      |
|                      | feel compelled to    |                      |
|                      | exercise or distress |                      |
|                      | if unable to         |                      |
|                      | exercise? == 'YES'   |                      |
+----------------------+----------------------+----------------------+
| Addictive Exercise   | Regular Compulsive   | Exercise for Weight  |
|                      | Exercise lasting at  | Control              |
|                      | Least 3 month        |                      |
|                      |                      | Regular Exercise for |
|                      | 1 or more of the     | Weight Control       |
|                      | following: caused    |                      |
...
|                      | illness or injury    |                      |
+----------------------+----------------------+----------------------+
| Excessive Exercise   | Compulsive Exercise  | Exercise for Weight  |
|                      |                      | Control              |
|                      | Duration \>= 1 month |                      |
|                      |                      | Compulsive Exercise  |
|                      | Frequency = 'Every   |                      |
...
|                      | Every Day'           |                      |
+----------------------+----------------------+----------------------+
| Compensatory         | Have you ever used   | NA                   |
...
|                      | exercise))           |                      |
+----------------------+----------------------+----------------------+
| Maladaptive Exercise | Compulsive Exercise  | NA                   |
|                      | == 'Yes' OR          |                      |
|                      | Compensatory         |                      |
|                      | Exercise == 'Yes'    |                      |
+----------------------+----------------------+----------------------+
