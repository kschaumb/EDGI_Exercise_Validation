...
EDGI_exercise_cleaned <- EDGI_exercise_cleaned %>% 
  mutate(ED100k_ex_compulsive_current2 = case_when(ED100k_ex_compulsive_current == 1 ~ 2, 
                                                 ED100k_ex_compulsive == 1 & ED100k_ex_compulsive_current == 0 ~ 1, 
                                                 ED100k_ex_compulsive == 0 ~ 0)) %>% 
...
knitr::kable(combined_table, row.names = FALSE)
```
