...
Overall, `r`% of the sample reported No history of maladaptive exercise, `r [[1]]$valid.prc[[2]]`% reported a history of maladaptive exercise that was not current, and `r [[1]]$valid.prc[[3]]`% reported current maladaptive exercise.
