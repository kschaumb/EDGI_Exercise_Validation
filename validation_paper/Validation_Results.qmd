...
SE_results$Demo_df$cohort <- 'SE'
SE_results$Demo_df$ethnicity <- NA
SE_results$Demo_df$sex <- NA
SE_results$Demo_df$ED100k_race_dummy_2_factor <- NA

USA_results$Demo_df$cohort <- 'USA'

# join the two dataframes
all_demo <- rbind(SE_results$Demo_df, USA_results$Demo_df)
```
...
knitr::kable(USA_results$CET_ANOVA_df)
knitr::kable(SE_results$CET_ANOVA_df)
```
...
knitr::kable(USA_results$CET_contrast_file)
knitr::kable(SE_results$CET_contrast_file)
```
