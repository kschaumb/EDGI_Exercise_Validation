...
# Name your cohort 
cohort <- 'USA' #Change this to reflect your cohort if you do not have it loaded already (will carry over from the scoring step if you do that immediately before)
